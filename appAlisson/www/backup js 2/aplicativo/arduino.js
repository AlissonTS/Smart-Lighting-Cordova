...
function onError(error) {
      window.plugins.toast.show('Sem Conexão de Coordenadas', 'long', 'bottom');
}
        ...
        tx.executeSql('SELECT latitude, longitude FROM arduino', [], function (tx, resultado) {
            ...
            // document.getElementById("verificador").innerHTML = "LOAD";
              ...
              if(rows.length>0){
                ...
                document.getElementById("lat").innerHTML = "Latitude não Setada";
                document.getElementById("lon").innerHTML = "Longitude não Setada";
              }
