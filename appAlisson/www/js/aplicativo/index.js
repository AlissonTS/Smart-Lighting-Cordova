...
function onSuccess(position) {
  ...
  document.getElementById("coordCel").innerHTML = "("+position.coords.latitude+", "+position.coords.longitude+")";
	...
	db.transaction(function(tx) {
      ...
      if(rows.length>0){
        document.getElementById("coordAcionador").innerHTML = "("+resultado.rows.item(0).latitude+", "+resultado.rows.item(0).longitude+")";
        ...
        document.getElementById("coordAcionador").innerHTML = "Coordenadas não Setadas";
